...
export default function Home() {
  const { ref, inView } = useInView({ threshold: 0.5 }); // Use a threshold of 0.5, meaning when 50% of the text is visible, it triggers inView
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
        ...
        <div className="aboutme">
                ...
                <h1 className="aboutme-text text-5xl py-16 lg:py-32 flex justify-center items-center lg:text-9xl ">
                  ...
                  <span className="px-10 text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5] font-sans">ABOUT ME</span>
                  </Slide>
                  <svg
                    className="hidden sm:block sm:scale-125 xl:scale-[200%]"
                    width="20"
        ...
        <div className="professional-skillset w-68 text-center lg:w-full">
                ...
                <Slide duration={1000} fraction={0.1} direction="down">
                  ...
                  <span className="px-10 text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5] font-sans">{" "}
                    PROFESSIONAL <span className="pl-20 md:p-0">SKILLSET</span></span>
        ...
        <div className="projects">
                ...
                <h1 className="projects-text text-5xl pt-40 flex justify-center items-center lg:text-9xl ">
                  ...
                  <Slide duration={1000} fraction={0.5} direction="down">
                  <span className="px-10 text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5] font-sans">PROJECTS</span>
                  </Slide>
                  <svg
                    className="hidden sm:block sm:scale-125 xl:scale-[200%]"
                    width="20"
        ...
        <div className="aboutme">
                ...
                <h1 className="aboutme-text text-5xl pt-40 flex justify-center items-center lg:text-9xl ">
                  ...
                  <Slide duration={1000} fraction={0.5} direction="down">
                  <span className="px-10 text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5] font-sans">CONTACT</span>
                  </Slide>
                  <svg
                    className="hidden sm:block sm:scale-125 xl:scale-[200%]"
                    width="20"
        ...
        <div className="contact-details flex flex-wrap lg:px-10 py-10 lg:flex-nowrap">
              ...
              {contactMethods.map((item, idx) => (
                ...
                <li key={idx}>
                  ...
                  <div className="mt-3 flex items-center gap-x-3 text-white">
                    ...
                    <p className="md:text-xl font-sans">{item.contact}</p>
                  </div>
                </li>
                </Fade>
              ))}
